...
public class JanelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nome_usuarioLabel = new javax.swing.JLabel();
        ...
        gridBagConstraints.insets = new java.awt.Insets(103, 9, 103, 100);
        JanelaPrincipalPanel.add(imagem, gridBagConstraints);

        nome_usuarioLabel.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        nome_usuarioLabel.setText("Usuário: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(20, 12, 0, 0);
        JanelaPrincipalPanel.add(nome_usuarioLabel, gridBagConstraints);

        nome_usuarioTextField.setBackground(java.awt.Color.white);
        nome_usuarioTextField.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        nome_usuarioTextField.setForeground(java.awt.Color.black);
        nome_usuarioTextField.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        nome_usuarioTextField.setDisabledTextColor(java.awt.Color.black);
        nome_usuarioTextField.setEnabled(false);
        nome_usuarioTextField.setFocusable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        ...
        JanelaPrincipalPanel.add(nome_usuarioTextField, gridBagConstraints);
...
//    
    ...
    private javax.swing.JLabel nome_usuarioLabel;
    private javax.swing.JTextField nome_usuarioTextField;
